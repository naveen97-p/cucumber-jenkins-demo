package TestRunner.BankDemo_RetailDemo_RetailDev;
...
@CucumberOptions(
        tags = "@retail-demo or @retail-dev or @banking",
...
// mvn clean test -Dtest=TestRunner.BankDemo_RetailDemo_RetailDev.JunitRunnerForAllApps