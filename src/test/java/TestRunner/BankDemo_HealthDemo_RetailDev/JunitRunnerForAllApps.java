package TestRunner.BankDemo_HealthDemo_RetailDev;
...
@CucumberOptions(
        tags = "@retail-dev or @banking or @health",
...
// mvn clean test -Dtest=TestRunner.BankDemo_HealthDemo_RetailDev.JunitRunnerForAllApps