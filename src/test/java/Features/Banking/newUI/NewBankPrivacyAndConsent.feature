@US08 @new-bank
Feature: New_Bank_US08 08 Privacy And Consent Test
...
#   Given User Accepts Cookies for Banking App
  ...
  @privacy-and-consent @new-bank
  Scenario Outline: US08-01 New_Bank: User completes the Privacy and Consent Check
